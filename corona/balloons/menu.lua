...
function scene:create( event )
	...
	local titleLogo = display.newText( "The Balloons", 0, 0, native.systemFont, 40 )
	titleLogo.x = display.contentWidth * 0.5
	titleLogo.y = 100

	local backgroundMusic = audio.loadSound( "sounds/introduction.mp3" )
	backgroundChannel = audio.play( backgroundMusic )
	
	-- create a widget button (which will loads level1.lua on release)
	playBtn = widget.newButton{
		label="Play Now",
		labelColor = { default={255, 255, 0}, over={128} },
		width=150, height=40,
